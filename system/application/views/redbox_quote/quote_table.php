...
//time array in hours
	...
	$this->table->set_heading('Subscription Pricing', '', '');
	$this->table->set_empty("&nbsp;");
	$this->table->add_row('Number of Channels', form_input('number_of_ports', set_value('number_of_ports', $number_of_ports), $fields));
