<head>
    ...
    <link rel='stylesheet' href='<?= base_url() ?>css/themes/template.css?220312' type='text/css' />
    ...
    <!--[if IE 7]>
    <link rel="stylesheet" href="<?= base_url() ?>css/themes/ie7.css" />
    <![endif]-->

    <!--[if IE 8]>
    <link rel="stylesheet" href="<?= base_url() ?>css/themes/ie8.css" />
    <![endif]-->
